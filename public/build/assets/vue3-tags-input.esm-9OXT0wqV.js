import{o as l,c as u,r as q,$ as z,q as O,b as m,F as M,k as A,z as I,W as F,a0 as K,t as H,m as B,f as y,g as $,y as R,n as C,e as W,X as G}from"./app-jXH5QC3l.js";var J=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function U(e,n,t){return t={path:n,exports:{},require:function(o,r){return X(o,r??t.path)}},e(t,t.exports),t.exports}function X(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var Q=U(function(e,n){(function(t,o){e.exports=o()})(J,function(){var t="__v-click-outside",o=typeof window<"u",r=typeof navigator<"u",i=o&&("ontouchstart"in window||r&&navigator.msMaxTouchPoints>0)?["touchstart"]:["click"],k=function(a){var c=a.event,h=a.handler;(0,a.middleware)(c)&&h(c)},T=function(a,c){var h=function(s){var f=typeof s=="function";if(!f&&typeof s!="object")throw new Error("v-click-outside: Binding value must be a function or an object");return{handler:f?s:s.handler,middleware:s.middleware||function(v){return v},events:s.events||i,isActive:s.isActive!==!1,detectIframe:s.detectIframe!==!1,capture:!!s.capture}}(c.value),b=h.handler,N=h.middleware,D=h.detectIframe,S=h.capture;if(h.isActive){if(a[t]=h.events.map(function(s){return{event:s,srcTarget:document.documentElement,handler:function(f){return function(v){var x=v.el,g=v.event,_=v.handler,w=v.middleware,E=g.path||g.composedPath&&g.composedPath();(E?E.indexOf(x)<0:!x.contains(g.target))&&k({event:g,handler:_,middleware:w})}({el:a,event:f,handler:b,middleware:N})},capture:S}}),D){var j={event:"blur",srcTarget:window,handler:function(s){return function(f){var v=f.el,x=f.event,g=f.handler,_=f.middleware;setTimeout(function(){var w=document.activeElement;w&&w.tagName==="IFRAME"&&!v.contains(w)&&k({event:x,handler:g,middleware:_})},0)}({el:a,event:s,handler:b,middleware:N})},capture:S};a[t]=[].concat(a[t],[j])}a[t].forEach(function(s){var f=s.event,v=s.srcTarget,x=s.handler;return setTimeout(function(){a[t]&&v.addEventListener(f,x,S)},0)})}},d=function(a){(a[t]||[]).forEach(function(c){return c.srcTarget.removeEventListener(c.event,c.handler,c.capture)}),delete a[t]},p=o?{beforeMount:T,updated:function(a,c){var h=c.value,b=c.oldValue;JSON.stringify(h)!==JSON.stringify(b)&&(d(a),T(a,{value:h}))},unmounted:d}:{};return{install:function(a){a.directive("click-outside",p)},directive:p}})}),Y=Q;const Z={class:"v3ti-loader-wrapper"},ee=m("div",{class:"v3ti-loader"},null,-1),te=m("span",null,"Loading",-1),ne=[ee,te];function ie(e,n){return l(),u("div",Z,ne)}function L(e,n){n===void 0&&(n={});var t=n.insertAt;if(!(!e||typeof document>"u")){var o=document.head||document.getElementsByTagName("head")[0],r=document.createElement("style");r.type="text/css",t==="top"&&o.firstChild?o.insertBefore(r,o.firstChild):o.appendChild(r),r.styleSheet?r.styleSheet.cssText=e:r.appendChild(document.createTextNode(e))}}var ae=`.v3ti-loader-wrapper {
  display: flex;
  align-items: center;
