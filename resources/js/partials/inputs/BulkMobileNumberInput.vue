            ...
            <div>
                ...
                <div class="flex space-x-2 mt-4">
                    ...
                    <DeleteButton
                        ...
                        @click="() => _deleteMobileNumber(triggerProps.hideModal)" size="xs" type="danger">
                        <span class="ml-2">Delete</span>
                    </DeleteButton>

                    <!-- Save Changes / Add Mobile Number Button -->
                    <PrimaryButton
                        @click="() => mobileNumber ? _updateMobileNumber(triggerProps.hideModal) : _createMobileNumber(triggerProps.hideModal)"
                ...
                <div :class="bodyClass">
                    ...
                    <template v-if="hasMobileNumbers">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <AddButton @click="() => showMobileNumber(triggerProps.showModal, null, null)" size="xs" type="light" class="w-48" rounding="rounded-full">
                    ...
                    <AddButton v-else @click="() => showMobileNumber(triggerProps.showModal, null, null)" size="xs" type="light" class="w-48" rounding="rounded-full">
