    ...
    <div>
        ...
        <div class="flex justify-start items-center border-dashed py-6">
            ...
            <template v-else>
                ...
                <TextHeader>{{ isCreating ? 'Add Promotion' : form.name }}</TextHeader>
        ...
        <form class="relative" action="#" method="POST">
            ...
            <Alert v-if="mustCreate || mustSaveChanges" type="warning" class="flex justify-between items-center mb-2">
                ...
                <PrimaryButton :action="isCreating ? createPromotion : updatePromotion" :loading="isSubmitting" class="w-40">
                ...
                <div class="col-span-4">
                    ...
                    <div v-if="promotion && hasInstructions" class="flex flex-col justify-between bg-white shadow-lg rounded-lg border p-4 relative">
                        ...
                        <div class="flex items-center space-x-4 mb-2">
                            ...
                            <Pill type="primary" :text="totalInstructions" :showDot="false"></Pill>
                        </div>
                ...
                <div class="flex justify-end">
                    ...
                    <ConfirmModal approveText="Delete Promotion" :approveAction="deletePromotion" :isLoading="isDeleting">
                        ...
                        <template #trigger="triggerProps">
                            ...
                            <!-- Delete Promotion Button - Triggers Confirmation Modal -->
...
<script>
    ...
    export default {
        ...
        components: {
            ...
            SelectInput, Datepicker, ConfirmModal, TextareaInput, PrimaryButton, SpinningLoader,
            LineSkeleton, SelectInputTags, MoreInfoPopover, BackdropLoader, ToogleSwitch,
            FormErrorMessages
        },
        data() {
            return {
        ...
        methods: {
            ...
            setPromotionFields() {
                ...
                this.form.discountFixedRate = this.covertToValidMoney(this.promotion.discountFixedRate.amountWithoutCurrency);
                ...
                this.form.minimumGrandTotal = this.covertToValidMoney(this.promotion.minimumGrandTotal.amountWithoutCurrency);
            ...
            createPromotion() {
                ...
                postApi(this.apiState.apiHome['_links']['createPromotion'], this.parseForm()).then(response => {
                    ...
                    if(response.status == 200) {
                        this.showSuccessfulNotification('Promotion created');
                ...
                putApi(this.promotion._links.updatePromotion, this.parseForm()).then(response => {
                    ...
                    if(response.status == 200) {
                        ...
                        if(response.data.updated) {
                             ...
                             */
                            this.showSuccessfulNotification('Promotion updated');
