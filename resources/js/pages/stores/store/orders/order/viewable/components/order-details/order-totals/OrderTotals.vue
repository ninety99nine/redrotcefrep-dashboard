    ...
    <div class="bg-blue-50 border border-blue-400 rounded-lg p-4">
        ...
        <template v-if="isLoadingOrder || !hasOrder || hasDiscountTotal || hasFeeTotal">
            ...
            <div class="flex items-center justify-between text-sm border-b border-dashed pb-2 mb-2">
                <span>Subtotal</span>
                <LineSkeleton v-if="isLoadingOrder || !hasOrder" width="w-24" color="bg-blue-200" :shine="true"></LineSkeleton>
        ...
        <template v-if="isLoadingOrder || !hasOrder || hasDiscountTotal">
            ...
            <div class="border-b border-dashed pb-2 mb-2">
                ...
                <div
                    ...
                    <LineSkeleton v-if="isLoadingOrder || !hasOrder" width="w-20" color="bg-blue-200" :shine="true"></LineSkeleton>
        ...
        <!-- Tax -->
         <div class="border-b border-dashed pb-2 mb-2">
            ...
            <div class="flex items-center justify-between text-sm mb-1">
                ...
                <LineSkeleton v-if="isLoadingOrder || !hasOrder" width="w-16" color="bg-blue-200" :shine="true"></LineSkeleton>
            ...
            <LineSkeleton v-if="isLoadingOrder || !hasOrder" width="w-1/3" color="bg-blue-200" :shine="true"></LineSkeleton>
