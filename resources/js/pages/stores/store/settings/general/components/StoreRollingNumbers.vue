<template>
    ...
    <BulkMobileNumberInput
        ...
        :createMobileNumber="createStoreRollingNumber"
        :updateMobileNumber="updateStoreRollingNumber"
        :deleteMobileNumber="deleteStoreRollingNumber"
        bodyClass="space-y-4 p-4 border rounded-lg shadow-lg">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            mobileNumbers() {
                return this.storeRollingNumbers.map((storeRollingNumber) => storeRollingNumber.mobileNumber.international);
            },
            storeRollingNumbers() {
        ...
        methods: {
            createStoreRollingNumber(typedMobileNumber, resetForm, hideModal) {

                //  Start loader
                this.isSubmitting = true;

                let data = {
                    mobileNumber: typedMobileNumber,
            ...
            updateStoreRollingNumber(typedMobileNumber, mobileNumberIndex, resetForm, hideModal) {
                ...
                const storeRollingNumber = this.storeRollingNumbers[mobileNumberIndex];

                putApi(storeRollingNumber._links.updateStoreRollingNumber, data).then(response => {
            ...
            deleteStoreRollingNumber(mobileNumberIndex, resetForm, hideModal) {
                ...
                deleteApi(storeRollingNumber._links.deleteStoreRollingNumber).then(response => {
