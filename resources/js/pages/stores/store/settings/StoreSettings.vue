        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6">
            ...
            <form class="mt-10" action="#" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <ToogleSwitch
                        v-model="allowDelivery" size="md"
                        labelPopoverTitle="What Is This?"
                        :errorText="getFormError('allowDelivery')"
                    ...
                    <template v-if="allowDelivery">
                        ...
                        <ToogleSwitch
                            v-model="allowFreeDelivery" size="md"
                            labelPopoverTitle="What Is This?"
                            :errorText="getFormError('allowFreeDelivery')"
                        ...
                        <!-- Info Alert -->
                        <Alert v-if="!allowFreeDelivery && isValidMoney(deliveryFlatFee) && deliveryFlatFee != '0'" class="flex space-x-2">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    ...
                                    <tr v-for="(deliveryDestination, index) in deliveryDestinations" :key="index" class="border-t">
                                        ...
                                        <td class="p-2">
                                            ...
                                            <div v-else class="w-full">
                                                ...
                                                <!-- Allow Free Delivery Toggle Switch -->
                                                <ToogleSwitch
                                                    v-model="deliveryDestination.allowFreeDelivery" size="sm"
                                                    :errorText="getFormError('deliveryDestinations'+index+'AllowFreeDelivery')"
                                                    labelPopoverTitle="What Is This?"
                    ...
                    <ToogleSwitch
                        v-model="allowPickup" size="md"
                        labelPopoverTitle="What Is This?"
                        :errorText="getFormError('allowPickup')"
                ...
                <template v-if="!isLoadingAvailablePaymentMethods && !isLoadingSupportedPaymentMethods">
                    ...
                    <template v-if="selectedPaymentMethodOptions.length">
                        ...
                        <!-- Info Alert -->
                        <Alert class="flex space-x-2 mt-4">
                                ...
                                <tbody>
                                    <tr v-for="(supportedPaymentMethod, index) in supportedPaymentMethods" :key="index" class="border-t">
                                        ...
                                        <td class="p-2">
                                            ...
                                            <ToogleSwitch
                                                labelPopoverTitle="What Is This?"
                                                v-model="supportedPaymentMethods[index].active" size="sm"
                                                :errorText="getFormError('pickupDestinations'+index+'Active')"
                ...
                <div class="space-y-4 mt-8">
                    ...
                    <ToogleSwitch
                        v-model="perfectPayEnabled" size="md"
                        labelPopoverTitle="What Is This?"
                        :errorText="getFormError('perfectPayEnabled')"
                        labelPopoverDescription="Turn on so that your store supports Perfect Pay payments (Perfect Order receives payments on your behalf and settles your preferred banking account based on your agreed settlement cycle)">
                    ...
                    <template v-if="!perfectPayEnabled">
                        ...
                        <ToogleSwitch
                            v-model="orangeMoneyPaymentEnabled" size="md"
                            labelPopoverTitle="What Is This?"
                            :errorText="getFormError('orangeMoneyPaymentEnabled')"
                        ...
                        <ToogleSwitch
                            v-model="dpoPaymentEnabled" size="md"
                            labelPopoverTitle="What Is This?"
                            :errorText="getFormError('dpoPaymentEnabled')"
                        ...
                        <PasswordInput
                            v-if="dpoPaymentEnabled"
                            v-model="dpoCompanyToken"
                ...
                <ToogleSwitch
                    v-model="allowDepositPayments" size="md"
                    labelPopoverTitle="What Is This?"
                    :errorText="getFormError('allowDepositPayments')"
                ...
                <ToogleSwitch v-model="allowInstallmentPayments" size="md"
                    labelPopoverTitle="What Is This?"
                    :errorText="getFormError('allowInstallmentPayments')"
                ...
                -->
                <Alert v-if="hasErrors" class="flex items-center space-x-2 mt-4" type="warning">
                ...
                <div class="px-20 mt-8">
                    ...
                    <!-- Save Changes Button -->
                    <PrimaryButton :action="updateStore" :loading="isSubmitting" class="w-full">
                        Save Changes
                    </PrimaryButton>
...
<script>
    ...
    export default {
        ...
        components: {
            Alert, InputTags, TextInput, TextHeader, StoreLogo, MoneyInput, PasswordInput,
            TextareaInput, PrimaryButton, SpiningLoader, SelectInputTags, MoreInfoPopover, ProfilePhoto, ToogleSwitch,
            MobileNumberInput,
        },
        data() {
            return {
