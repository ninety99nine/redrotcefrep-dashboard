    ...
    <div>
        ...
        <div class="flex justify-start items-center border-dashed py-6">
            ...
            <template v-else>
                ...
                <h1 class="text-2xl font-bold tracking-tight text-gray-900">{{ isCreating ? 'Add Product' : form.name }}</h1>
            ...
            <div class="col-span-8 relative">
                ...
                <div class="space-y-4 bg-white shadow-lg rounded-lg border p-4 mb-4">
                    ...
                    <template v-if="form.allowVariations == false">
                        ...
                        <ToggleSwitch
                            ...
                            v-model="form.isFree"
                            labelPopoverTitle="What Is This?"
                            :errorText="formState.getFormError('isFree')"
                        ...
                        <template v-else>
                            ...
                            <MoneyInput
                                ...
                                labelPopoverTitle="What Is This?"
                                :errorText="formState.getFormError('unitRegularPrice')"
                            ...
                            <MoneyInput
                                ...
                                labelPopoverTitle="What Is This?"
                                :errorText="formState.getFormError('unitSalePrice')"
                        ...
                        <ToggleSwitch
                            ...
                            labelPopoverTitle="What Is This?"
                            :errorText="formState.getFormError('showDescription')"
                        ...
                        <div class="flex space-x-4">
                            ...
                            <SelectInput
                                ...
                                labelPopoverTitle="What Is This?"
                                :errorText="formState.getFormError('stockQuantityType')"
                            ...
                            <NumberInput
                                ...
                                :errorText="formState.getFormError('stockQuantity')"
                        ...
                        <div class="flex space-x-4">
                            ...
                            <SelectInput
                                ...
                                :errorText="formState.getFormError('allowedQuantityPerOrder')"
                            ...
                            <NumberInput
                                ...
                                :errorText="formState.getFormError('maximumAllowedQuantityPerOrder')"
                ...
                <div class="space-y-4 bg-white shadow-lg rounded-lg border p-4 mb-4">
                    ...
                    <ToggleSwitch
                        ...
                        :errorText="formState.getFormError('allowVariations')"
                    ...
                    <div v-if="!hasOriginalVariantAttributes">
                        ...
                        <div class="flex justify-between p-20 border rounded-lg bg-gray-50">
                            ...
                            <div class="space-y-4">
                                ...
                                <p v-if="hasVariantAttributes">Click the <Pill type="primary" size="xs" :showDot="false">Create Variations</Pill> button to create different variations of your product e.g different sizes, materials, colors, etc</p>
                                <p v-else-if="form.allowVariations">Click the <Pill type="primary" size="xs" :showDot="false">+ Add Option</Pill> button to add different variations of your product e.g different sizes, materials, colors, etc</p>
                                <p v-else>Turn on <Pill type="primary" size="xs" :showDot="false">Allow variations</Pill> if you want your product to support variations (different versions of itself e.g different sizes, materials, colors, etc)</p>
                        ...
                        <div v-for="(variantAttribute, index) in form.variantAttributes" :key="index" class="relative bg-gray-50 p-4 border rounded-lg">
                            ...
                            <div v-if="form.variantAttributes[index].isEditable" class="space-y-4">
                                ...
                                <TextInput
                                    ...
                                    :errorText="formState.getFormError('variantAttributes'+index+'name')"
                                ...
                                <TextInput
                                    ...
                                    :errorText="formState.getFormError('variantAttributes'+index+'instruction')"
                                ...
                                <InputTags
                                    ...
                                    :errorText="formState.getFormError('variantAttributes'+index+'value')"
                            ...
                            <div v-else class="space-y-2 cursor-pointer" @click="form.variantAttributes[index].isEditable = true">
                                ...
                                <!-- Input Error Message -->
                                <InputErrorMessage v-if="formState.getFormError('variantAttributes'+index+'name')" :errorText="formState.getFormError('variantAttributes'+index+'name')"></InputErrorMessage>

                                <!-- Variant Attribute Instruction -->
                                <p class="text-xs text-black">{{ form.variantAttributes[index].instruction }}</p>

                                <!-- Input Error Message -->
                                <InputErrorMessage v-if="formState.getFormError('variantAttributes'+index+'name')" :errorText="formState.getFormError('variantAttributes'+index+'instruction')"></InputErrorMessage>
                                ...
                                <!-- Input Error Message -->
                                <InputErrorMessage v-if="formState.getFormError('variantAttributes'+index+'name')" :errorText="formState.getFormError('variantAttributes'+index+'value')"></InputErrorMessage>
...
<script>
    ...
    export default {
        ...
        components: {
            Pill, Alert, Button, TextInput, MoneyInput, InputTags, NumberInput, SelectInput,ConfirmModal,
            TextareaInput, SpinningLoader, LineSkeleton, MoreInfoPopover, BackdropLoader,
            ToggleSwitch, FormErrorMessages, InputErrorMessage, ProductVariations
        },
        data() {
            return {
                form: {
        ...
        methods: {
            setProductFields() {
                ...
                this.form.unitSalePrice = convertToValidMoney(this.product.unitSalePrice.amountWithoutCurrency, currency);
                this.form.unitRegularPrice = convertToValidMoney(this.product.unitRegularPrice.amountWithoutCurrency, currency);
            ...
            createProduct() {
                ...
                if(this.form.name.trim() == '') {
                    this.formState.setFormError('name', 'The product name is required');
                ...
                if(this.form.allowVariations && this.form.variantAttributes.length == 0) {
                    this.formState.setFormError('allowVariations', 'Add variation options');
                    this.notificationState.showWarningNotification('Add variation options');
                    window.scrollTo(0, 0);
                    return;
                }
