    ...
    <div>
        ...
        <div class="max-w-lg mx-auto bg-white border border-gray-200 rounded-lg shadow p-6 mb-8">
            ...
            <form action="#" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Mobile Number Input -->
                    <MobileNumberInput
                        v-model="ussdMobileNumber"
                        labelPopoverTitle="What Is This?"
                        :errorText="getFormError('ussdMobileNumber')" @keydown.enter="createStore"
                        labelPopoverDescription="The mobile number that will be used by customers to dial your store">
                    </MobileNumberInput>

                    <!-- Mobile Number Input -->
                    <div class="flex items-center space-x-2">
                        <svg class="w-8 h-8" fill="#44c152" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 308 308" xml:space="preserve">
                            <g id="XMLID_468_">
                        ...
                        <MobileNumberInput
                            v-model="whatsappMobileNumber"
                            labelPopoverTitle="What Is This?"
                            :errorText="getFormError('whatsappMobileNumber')" @keydown.enter="createStore"
                            labelPopoverDescription="The mobile number that will be used by customers to send orders via whatsapp">
                        </MobileNumberInput>
                    </div>
        ...
        <div class="max-w-lg mx-auto bg-white border border-gray-200 rounded-lg shadow p-6">
            ...
            <div class="space-y-2 border-b mb-2 pb-2">
                ...
                <!-- Quick Start Guide (Heading) -->
                <h1 class="text-2xl font-bold">{{ name == '' ? 'My Store' : name }}</h1>
            ...
            <div class="space-y-2 border-b mb-2 py-2">
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="text-sm">
                        ...
                        <div class="font-bold mt-2">https://perfectorder.shop/{{ nationalMobileNumber }}</div>
                    </div>
                </div>
    ...
    export default {
        ...
        computed: {
            nationalMobileNumber() {
                if(this.ussdMobileNumber) {
                    const phoneNumber = parsePhoneNumberFromString(this.ussdMobileNumber);
        ...
        methods: {
            createStore() {
                ...
                }else if(this.ussdMobileNumber.trim() == '') {

                    this.setFormError('ussdMobileNumber', 'Enter store mobile number');
        ...
        created() {
            this.ussdMobileNumber = this.authState.user.mobileNumber.international;
        }
    };
