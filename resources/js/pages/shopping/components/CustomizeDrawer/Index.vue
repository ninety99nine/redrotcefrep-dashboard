<template>
    ...
    <Drawer ref="customizeDrawer" placement="right" :bodyScrolling="true" :backdrop="false" :hideCloseIcon="true">
        <template #content>
        ...
        <!-- Trigger -->
        <template #trigger>
            <div @click="openCustomizeDrawer"
                 class="p-2 bg-white rounded-full fixed bottom-8 right-8 cursor-pointer hover:opacity-90 active:opacity-80 active:scale-90 transition-all">
