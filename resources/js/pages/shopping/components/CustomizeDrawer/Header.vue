<template>
    ...
    <div class="flex justify-between items-center space-x-2 bg-gray-100 border-b shadow-sm p-4">
        ...
        <div class="flex items-center space-x-2">
            ...
            <!-- Customize Icon -->
            <svg class="w-5 h-5 md:w-6 md:h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <!-- Heading -->
            <h2 class="text-gray-400 text-lg md:text-xl font-bold">
                Customize
            </h2>
